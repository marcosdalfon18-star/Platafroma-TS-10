                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-600 mb-8">
                                Somos un equipo de expertos en tecnología digital comprometidos con el éxito de nuestros clientes. 
                                Combinamos creatividad, innovación y experiencia técnica para entregar soluciones que realmente funcionan.
                            </p>
                    ...
                    <div className="bg-gray-50 rounded-2xl p-8">
                        <form className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea id="message" rows={4} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Cuéntanos sobre tu proyecto..."></textarea>
                            </div>
                            <div className="md:col-span-2">
                                <Button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 px-8 rounded-lg font-semibold text-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300">
                                    Enviar Mensaje
                                </Button>
                            </div>
                        </form>
