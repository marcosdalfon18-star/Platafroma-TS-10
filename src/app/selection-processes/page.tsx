...
// import GenerateAdModal from '@/components/modals/GenerateAdModal'; // Temporalmente comentado

// Modal temporal para generar anuncios
interface JobPositionType {
  title: string;
  [key: string]: unknown;
}

const GenerateAdModal = ({ 
  isOpen, 
  onClose, 
  jobPosition 
}: { 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-md w-full">
        <h2 className="text-xl font-bold mb-4">Generar Anuncio de Trabajo</h2>
        <p className="mb-4">
          Generando anuncio para: {jobPosition?.title || 'Posición'}
        </p>
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Esta funcionalidad está siendo implementada con AI.
          </p>
          <button 
            onClick={onClose}
...
const orgStructure: Array<{
...
}> = [
    {
        ...
        positions: [
            { id: 1, title: "CEO", current: "Elena Campos", status: "occupied", hasAnalysis: true },
            { id: 2, title: "Asistente Ejecutivo", current: null, status: "vacant", hasAnalysis: true, priority: "high" }
        ]
    },
    {
        department: "Tecnología",
        positions: [
            { id: 3, title: "CTO", current: "Ana Torres", status: "occupied", hasAnalysis: true },
            { id: 4, title: "Desarrollador Senior", current: "Miguel Santos", status: "occupied", hasAnalysis: true },
            { id: 5, title: "Desarrollador Frontend", current: null, status: "vacant", hasAnalysis: true, priority: "medium" },
            { id: 6, title: "DevOps Engineer", current: null, status: "vacant", hasAnalysis: false, priority: "low" }
        ]
    },
    {
        department: "Operaciones", 
        positions: [
            { id: 7, title: "COO", current: "Carlos Mendoza", status: "occupied", hasAnalysis: true },
            { id: 8, title: "Gerente de Proyectos", current: "Sofía Reyes", status: "occupied", hasAnalysis: true },
            { id: 9, title: "Coordinador de Logística", current: null, status: "vacant", hasAnalysis: true, priority: "high" }
        ]
    },
    {
        department: "Recursos Humanos",
        positions: [
            { id: 10, title: "Especialista en RRHH", current: null, status: "vacant", hasAnalysis: false, priority: "medium" },
            { id: 11, title: "Reclutador", current: null, status: "vacant", hasAnalysis: true, priority: "high" }
        ]
    }
];
    ...
    return (
        <div className="space-y-6">
            <header className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-bold">Selección de Personal</h1>
